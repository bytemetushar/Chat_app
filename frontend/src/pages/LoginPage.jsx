  ...
  return (
      <div className='min-h-screen grid lg:grid-cols-2'>
            ...
            <div className='w-full max-w-md space-y-8'>
                ...
                <div className='text-center mb-8'>
                    <div className='flex flex-col items-center gap-2 group'>
                        ...
                        <p className='text-base-content/60'>Start for chat with your friends</p>
                    </div>
                </div>
        ...
        <AuthImagePattern
            ...
            subtitle="Connect with friends, Share moments and stay in touch around with your loved ones."
        />
    </div>
  )
}
